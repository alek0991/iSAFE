...
def run():
    ...
    parser.add_argument('--topk', '-k', type=int, help='Rank of SNPs used for learning window weights (alpha) [1]', required=False, default=1)
    parser.add_argument('--MaxRank', '-MR', type=int, help='Ignore SNPs with rank higher than MAXRANK [15]', required=False, default=15)
    ...
    if args.OutputPsi:
        ...
        psi_k1.to_csv("%s.Psi"%output_file)
